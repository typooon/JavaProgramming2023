                ...
                if(menu == 1){
                    while(true){
                        ...
                        if (skillMenu <= player.skills.size())
                        {
                            ...
                            enemy.enemyattack(player, (int)(Math.random() * 3)+1);
                            break;
                        }else {
                    ...
                    System.out.println("힐 포션을 마십니다. 체력이 30만큼 증가합니다.");
...
//                if(pokemonPick == 1){
//                    //player = new Pikachu(new NoFly());
//                    player = new Pikachu(()-> System.out.println("로켓추진기로 날아갑니다"));//1회용
//                    //객체와 리턴 없이 실행가능
//                    break;
//                }else if(pokemonPick == 2){
//                    player = new Squirtle(new NoFly());
...
//                            break;
//                        }else {
//                            System.out.println("기술을 다시 선택해 주세요.");
//                        }
//                    }
//                } else if (menu == 2) {
//                    player.performFly();
...
//            System.out.println("예외 내용 : " + err.getMessage());
//        }catch (NullPointerException err) {
//            System.out.println("플레이어 객체가 생성되지않았습니다.");
//            System.out.println("예외내용 : "+ err.getMessage());
//        }catch (IndexOutOfBoundsException err) {
//            System.out.println("존재하지 않는 스킬입니다.");
//            System.out.println("예외 내용 : " + err.getMessage());
//        }catch (Exception err){
//            System.out.println("예외가 발생했습니다.");
//            System.out.println("예외 내용 : " + err.getMessage());
